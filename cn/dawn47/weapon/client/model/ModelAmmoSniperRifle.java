 ...
 * 
 */
public class ModelAmmoSniperRifle extends ModelBase implements IItemModel {

	// fields
	ModelRenderer Shape1;
	ModelRenderer Shape2;

	public ModelAmmoSniperRifle(boolean isItem) {
		textureWidth = 64;
		textureHeight = 32;

		int offset = isItem ? 0 : -16;
		Shape1 = new ModelRenderer(this, 0, 3);
		Shape1.addBox(0F, 0F, 0F, 4, 2, 2);
		Shape1.setRotationPoint(0F, 1F + offset, -0.5F);
		Shape1.setTextureSize(64, 32);
		Shape1.mirror = true;
		setRotation(Shape1, 0.7853982F, 0F, 0F);
		Shape2 = new ModelRenderer(this, 0, 0);
		Shape2.addBox(0F, 0F, 0F, 4, 1, 1);
		Shape2.setRotationPoint(-4F, 0.5F + offset, 0.5F);
